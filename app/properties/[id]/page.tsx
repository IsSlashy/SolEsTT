          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <div className="text-gray-400 text-sm mb-2">Total Property Value</div>
                  <div className="text-2xl font-bold">{formatPrice(property.totalValue)}</div>
                </div>
                <div>
                  <div className="text-gray-400 text-sm mb-2">Monthly Rent</div>
                  <div className="text-2xl font-bold text-green-400">{formatPrice(property.rentPerMonth)}</div>
                </div>
                <div>
                  <div className="text-gray-400 text-sm mb-2">Annual Return</div>
                  <div className="text-2xl font-bold text-purple-400">{formatPrice(property.rentPerMonth * 12)}</div>
                </div>
              </div>
            ...
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 sticky top-6">
              ...
              {connected ? (
                <button
                  ...
                  className="w-full py-4 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed rounded-lg font-bold text-lg transition-colors"
                >
                  {loading ? 'Processing...' : property.availableShares === 0 ? 'Sold Out' : 'Buy Shares'}
                </button>
              ) : (
                <div className="text-center p-4 bg-gray-900 rounded-lg">
                  <p className="text-gray-400 mb-2">Connect wallet to invest</p>
                </div>
              )}
