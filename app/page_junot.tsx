      ...
      <main className="container mx-auto px-6 py-16 relative z-10">
        ...
        <div className="text-center space-y-8 py-20 fade-in-up visible">
          <div className="inline-block">
            ...
            >
              <h1 className="text-7xl font-bold mb-4 bg-gradient-to-r from-white via-junot-gold to-junot-gold-light bg-clip-text text-transparent">
                SolEsTT
              </h1>
              <div className="h-1 w-32 bg-gradient-to-r from-junot-gold to-junot-gold-light mx-auto mb-6"></div>
            </motion.div>
            <h2 className="text-4xl font-serif font-normal text-junot-blue-light">
          ...
          <p className="text-lg text-junot-blue-light max-w-2xl mx-auto leading-relaxed">
            Tokenisez des propriétés d'excellence, investissez de manière fractionnée,
            et gérez vos revenus locatifs sur Solana.
            <br />
            <span className="text-white font-semibold">35 ans d'expertise Junot × La puissance de Solana</span>
          </p>
        ...
        <div className="py-20 border-t border-junot-border-primary">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="modern-card">
                ...
                <p className="text-junot-blue-light text-sm leading-relaxed">
        ...
        <div className="py-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-junot-gold to-junot-gold-light text-junot-navy-dark rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4 transition-transform group-hover:scale-110 shadow-lg">
                1
              </div>
              <h4 className="font-semibold mb-2 text-base text-white">Connectez votre Wallet</h4>
              <p className="text-junot-blue-muted text-sm">Liez votre wallet Solana pour commencer</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-semibold mb-2 text-base text-white">Parcourez les Biens</h4>
              <p className="text-junot-blue-muted text-sm">Explorez les opportunités immobilières tokenisées</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-semibold mb-2 text-base text-white">Investissez</h4>
              <p className="text-junot-blue-muted text-sm">Achetez des parts fractionnées avec SOL ou USDC</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-semibold mb-2 text-base text-white">Percevez des Revenus</h4>
              <p className="text-junot-blue-muted text-sm">Recevez les loyers directement sur votre wallet</p>
            </div>
          </div>
        </div>
        ...
        {!connected && (
          <div className="text-center py-16 modern-card border-junot-gold">
            ...
            <p className="text-junot-blue-light mb-8">Connectez votre wallet pour explorer la plateforme</p>
            <div className="status-dot inline-block"></div>
          </div>
        )}
      </main>

      <footer className="relative z-10 border-t border-junot-border-primary py-8 text-center bg-junot-navy-dark">
        <p className="text-junot-blue-light text-sm">
        ...
        <p className="text-xs mt-2 text-junot-blue-muted">
          Propulsé par <span className="text-white">Solana Blockchain</span> • 35 ans d'excellence Junot
        </p>
      </footer>
      </PageTransition>
    </div>
